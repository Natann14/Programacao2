%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Projeto de Extensão da disciplina de Programação 2 
...
%    $ pdflatex pext-programa2-benante-sobrenome1-sobrenome2.tex -o pext-programa2-benante-sobrenome1-sobrenome2.pdf
%    $ bibtex biblio 
%    $ pdflatex pext-programa2-benante-sobrenome1-sobrenome2.tex -o pext-programa2-benante-sobrenome1-sobrenome2.pdf
...
\textbf{Caracterização:} Projeto de Extensão requisito da disciplina de Programação 2, sub-projeto integrante do Projeto \texttt{ProgramAuto}
