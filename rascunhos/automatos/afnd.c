...
#include "afnd.h" /* To be created for this template if needed */
...
int main(int argc, char *argv[])
{
 ...
 //   IFDEBUG("Starting optarg loop...");
    ...
    auto1_init(); /* initialization function */
...
{
    IFDEBUG("help()");
    printf("%s v.%s - %s\n", "Auto1", VERSION, "Convert AFND into AFD");
    printf("\nUsage: %s [-h|-v|-c]\n", "Auto1");
    printf("\nOptions:\n");
    printf("\t-h,  --help\n\t\tShow this help.\n");
    ...
    printf("\n\nNote (-n): A entrada de dados sera uma quintupla de um AFND que sera\n\t   covertido para AFD.\n");
