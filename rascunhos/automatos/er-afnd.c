...
#include "er-afnd.h" /* To be created for this template if needed */
...
int main(int argc, char *argv[])
{
 ...
 //   IFDEBUG("Starting optarg loop...");
    ...
    auto3_init(); /* initialization function */
...
void help(void)
{
    ...
    printf("\n\nNote (-e): A entrada de dados sera uma quintupla de um ER que sera\n\t   covertido para AFND.\n");
