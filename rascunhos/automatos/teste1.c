...
#define IMAGENAME "teste1.bmp" /* nome do arquivo de imagem */
...
int main(void)
{
  ...
  textprintf_ex(buff, font, 600, 700, CORVERDE, CORPRETO, "Estado final: Q1");
  ...
  textprintf_ex(buff, font, 750, 380, CORBRANCO, CORPRETO, "E");
