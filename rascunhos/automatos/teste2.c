...
#define IMAGENAME "teste2.bmp" /* nome do arquivo de imagem */
...
int main(void)
{
  ...
  textprintf_ex(buff, font, 340, 710, CORVERDE, CORPRETO, "Auto1 AFD");
  ...
  //textprintf_ex(buff, font, 690, 580, CORBRANCO, CORPRETO, "=======");
  ...
  textprintf_ex(buff, font, 350, 530, CORBRANCO, CORPRETO, "A");
